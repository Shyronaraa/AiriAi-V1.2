...
const fcon = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': `${global.nameown}`,}}}
      ...
      contextInfo: {
        externalAdReply: {
         showAdAttribution: true,
          title: waktuwib,
          thumbnailUrl: `https://0x0.st/Xml9.jpg`,
          sourceUrl: null,
          mediaType: 1,
